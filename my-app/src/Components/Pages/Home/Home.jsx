...
export const Home = () => {
 ...
 <section className='flex flex-col items-center justify-center'>
   ...
   <section className="about my-20 md:my-10 xl:mx-64  mx-12 md:py-4 flex flex-col justify-center items-center space-y-2">
...
Located in the heart of Colombo <b>EkBar Hotels</b> offers a
 ...
 making every stay memorable.
    ...
    <div className="mobile lg:hidden">
        ...
        <div className="about-img shadow-lg flex justify-center items-center rounded-3xl">
        <div className="h-[350px] rounded-3xl bg-yellow-500 mx-auto w-[280px] "></div>
            <div className="w-[280px]  h-[450px]  absolute flex justify-center items-center rounded-3xl">
            <div className="absolute  w-[250px] text-black space-y-2">
            <h2 className=" text-center font-bold text-3xl  text-red-700 ">
        Our Amenities
      </h2>
      <ul className='text-center text-sm'>
      <li><b>Comfortable Rooms & Suites:</b> Modern amenities with local charm.</li>
